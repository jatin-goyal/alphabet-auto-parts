    ...
    <div className="grid gap-4 lg:grid-cols-5 w-100">
      <div className="order-last flex gap-4 lg:order-none lg:flex-col">
        {images.map((image: any, idx: any) => (
          <div
            key={idx}
            className="overflow-hidden rounded-lg bg-gray-100 lg:hover:scale-110 transition duration-150 ease-out hover:ease-in"
          >
            <Image
      ...
      <div className="relative overflow-hidden rounded-lg bg-gray-100 lg:col-span-4 h-full lg:h-4/5 hover:origin-top lg:hover:scale-150  transition duration-150 ease-out hover:ease-in-out duration-300">
        <Image
