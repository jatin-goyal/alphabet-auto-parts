...
export default function WhatsappPlugin() {
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="fixed bottom-5 left-5 bg-white border-4 border-lime-600 rounded-full p-2 md:hover:scale-110 transition duration-150 ease-out hover:ease-in shadow-2xl">
