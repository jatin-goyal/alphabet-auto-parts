...
export default function WhatsappPlugin() {
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="fixed bottom-5 left-10 bg-white border-8 border-lime-600 rounded-full p-2 hover:scale-110 transition duration-150 ease-out hover:ease-in">
